...
public class Main {
	...
	public static void registerTourist(
	        Scanner sc,
	        TouristManager manager,
	        TouristBST bst) {
		 ...
		 String name;
		    ...
		    System.out.printf("%-12s : %s%n", "Travel ID", travelId);
		    System.out.printf("%-12s : %s%n", "Name", name);
		    System.out.printf("%-12s : %s%n", "Category", category);
		    System.out.printf("%-12s : %s%n", "Destination", destination);    
		    ...
		    if (source >= 1 && source <= 5) {
		    	...
		    	System.out.printf("%-18s : %.1f Hours%n",
		    	        "Travel Time", time);
...
public static void main(String[] args) {
    ...
    TouristManager manager =
            new TouristManager();
    TouristDelete delete = new TouristDelete();
    DestinationManager dm = new DestinationManager();
    TouristBST bst =
            new TouristBST();
    ...
    case 2:
        ...
        case 3:
            ...
            dm.displayAllDestinations();
            break;

        case 4:

            System.out.print(
                    "Enter Travel ID to Delete: ");
        ...
        case 6:
            ...
            System.out.println(
                    "\nThank you for using YatraSphere!");
            System.out.println(
